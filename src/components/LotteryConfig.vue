<template>
  <el-dialog :visible="visible" :append-to-body="true" width="400px" @close="$emit('update:visible', false)"
    ...
    <div class="container">
      <el-form ref="form" :model="form" label-width="90px" size="mini">
        ...
        <el-form-item label="特等奖">
          <el-input type="number" v-model="form.specialAward" :min="0" :step="1"></el-input>
        </el-form-item>
        ...
        <el-form-item label="三等奖">
          <el-input type="number" v-model="form.thirdPrize" :min="0" :step="1"></el-input>
        </el-form-item>
        <el-form-item label="四等奖">
          <el-input type="number" v-model="form.fourthPrize" :min="0" :step="1"></el-input>
        </el-form-item>
        <el-form-item label="五等奖">
          <el-input type="number" v-model="form.fifthPrize" :min="0" :step="1"></el-input>
        </el-form-item>
...
<style type="text/css">
  .c-LotteryConfig .el-dialog__body {
    height: 340px;
  }

  .c-LotteryConfig .el-dialog__body .container {
    height: 100%;
    overflow-y: auto;
    padding: 0 10px;
  }

  .dialog-showAddLottery .el-dialog {
    height: 186px;
  }
</style>